...
def create_target_np(all_anchors,
    ...
    if len(gt_boxes) > 0:
        ...
        # print("similarity matrix \n", anchor_by_gt_overlap[anchor_by_gt_overlap>0.7])
        # print("similarity matrix unique 0.5 \n", np.unique(anchor_by_gt_overlap>0.7, \
        #                                                     return_counts = True))
        ...
        anchor_to_gt_max = anchor_by_gt_overlap[np.arange(num_inside),
                                                anchor_to_gt_argmax]  #
        # print("anchor_to_gt_max ", anchor_by_gt_max)
